...
#                                         menuDivStr += """<li ><a href="/""" + appName + """/doctor_visit/prescription_list"><div>Prescription</div></a></li>"""
                        ...
                        if session.setting_report == 1:# if open set 1
                            if check_role('rm_tour_view') == True or check_role('rm_tracking_view') == True or check_role('rm_rpt_sales2') == True or check_role('rm_rpt_sales') == True or check_role('rm_rpt_stock_and_coll') == True or check_role('rm_rpt_analysis') == True or check_role('rm_analysis_view') == True or check_role('rm_rpt_sales_dist') == True:  #Reports
...
#                                     menuDivStr += """<li ><a href="/""" + appName + """/dashboard/dashboard"><div>Dashboard</div></a></li>"""
                                if check_role('rm_analysis_view') == True or check_role('rm_rpt_sales_dist') == True:
                                    menuDivStr += """<li ><a href="/""" + appName + """/report_sales_dist/home"><div>Sales (Dist.)</div></a></li>"""

                                if check_role('rm_analysis_view') == True or check_role('rm_rpt_analysis') == True:
                                    menuDivStr += """<li ><a href="/""" + appName + """/analysis/analysis"><div>Analysis</div></a></li>"""

                                if check_role('rm_analysis_view') == True or check_role('rm_rpt_stock_and_coll') == True:
                                    menuDivStr += """<li ><a href="/""" + appName + """/report/home"><div>Stock & Collection</div></a></li>"""

                                if check_role('rm_analysis_view') == True or check_role('rm_rpt_sales') == True:
                                    menuDivStr += """<li ><a href="/""" + appName + """/report_sales/home"><div>Sales</div></a></li>"""

                                if check_role('rm_analysis_view') == True or check_role('rm_rpt_sales2') == True:
                                ...
                                #if session.user_type == 'Admin':
                                if check_role('rm_analysis_view') == True or check_role('rm_tracking_view') == True:
                                    menuDivStr += """<li ><a href="/""" + appName + """/tracking/tracking"><div>Tracking</div></a></li>"""

                                if check_role('rm_analysis_view') == True or check_role('rm_tour_view') == True:
