...
def get_doctor_type():
    ...
    rows = db(db.seen_rx_type.cid == cid).select(db.seen_rx_type.name, orderby=db.seen_rx_type.name, groupby=db.seen_rx_type.name)     
...
def index():
    ...
    update_seenDetails="UPDATE sm_prescription_seen_details d, sm_prescription_seen_head h set d.formation = h.rx_type   where d.cid=h.cid AND d.sl=h.sl AND d.doctor_id=h.doctor_id;"
    upRun=db.executesql(update_seenDetails)
    ...
    if btn_corp_share_by_brand or btn_institute_track2 or btn_company_track2_rm or btn_company_track2 :
        ...
        pr_doctor_type=request.vars.pr_doctor_type
        ...
        if dateFlag!=False:
            if btn_sum_day_wise:
                ...
                redirect (URL('sum_reg_wise',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)))
            
            elif btn_sum_reg_wise_d:
                redirect (URL('sum_reg_wise_d',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)))
                        
            elif btn_sum_zone_wise:
                redirect (URL('sum_zone_wise',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)))
            elif btn_sum_zone_wise_d:
                redirect (URL('sum_zone_wise_d',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)))
                        
            elif btn_sum_area_wise1:
                redirect (URL('sum_area_wise1',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)))
            elif btn_sum_area_wise1_d:
                redirect (URL('sum_area_wise1_d',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)))
            
            elif btn_sum_territory_wise:
                redirect (URL('sum_territory_wise',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)))
            elif btn_sum_territory_wise_d:
                redirect (URL('sum_territory_wise_d',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)))
            
            elif btn_sum_submit_by_wise:
                redirect (URL('sum_submit_by_wise',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)))
            elif btn_sum_submit_by_wise_d:
                redirect (URL('sum_submit_by_wise_d',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)))
            
            elif btn_sum_no_submission:
                redirect (URL('no_submission_area',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)))
            elif btn_sum_no_submission_d:
                redirect (URL('no_submission_area_d',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)))
            
            if mpo_ranking:
                redirect (URL('sin_mpo_ranking',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doc=pr_doc,pr_ff=pr_ff,pr_brand=pr_brand)))
            if am_ranking:
                redirect (URL('sin_fm_ranking',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doc=pr_doc,pr_ff=pr_ff,pr_brand=pr_brand)))
            if zm_ranking:
                redirect (URL('sin_zm_ranking',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doc=pr_doc,pr_ff=pr_ff,pr_brand=pr_brand)))
            if rsm_ranking:
                redirect (URL('sin_rsm_ranking',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doc=pr_doc,pr_ff=pr_ff,pr_brand=pr_brand)))            

            if dr_mpo_ranking:
                redirect (URL('dr_sin_mpo_ranking',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doc=pr_doc,pr_ff=pr_ff,pr_brand=pr_brand)))
            if dr_am_ranking:
                redirect (URL('dr_sin_fm_ranking',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doc=pr_doc,pr_ff=pr_ff,pr_brand=pr_brand)))
            if dr_zm_ranking:
                redirect (URL('dr_sin_zm_ranking',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doc=pr_doc,pr_ff=pr_ff,pr_brand=pr_brand)))
            if dr_rsm_ranking:
                redirect (URL('dr_sin_rsm_ranking',vars=dict(pr_doctor_type=pr_doctor_type,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doc=pr_doc,pr_ff=pr_ff,pr_brand=pr_brand)))
    ...
    drType_rows = db(db.seen_rx_type.cid == c_id).select(db.seen_rx_type.name, orderby=db.seen_rx_type.name, groupby=db.seen_rx_type.name)     
      
    return dict(drType_rows=drType_rows,regionRows=regionRows,brandRows=brandRows,search_form=search_form)
...
def sum_submit_by_wise_d():
    ...
    if pr_doctor_type!='':
        # return len(pr_doctor_type)
        pr_doctor_type=str(pr_doctor_type).replace("[","").replace("]","")
        pr_doctor_type=str(pr_doctor_type).replace("'', '"," ")
        ...
        if pr_doctor_type.find(' ')!=0:
            pr_doctor_type="' "+pr_doctor_type+"'"
        else:
            pr_doctor_type="'"+pr_doctor_type+"'"
    ...
    if pr_doctor_type != '':
        condition1 += " and b.formation in (" + str(pr_doctor_type) + ")"
...
#        condition += " and b.generic = '" + str(med_generic)+ "'"
    ...
    myString += 'Doctor Type:' + ',' + str(pr_doctor_type) + '\n'
...
#        condition += " and b.generic = '" + str(med_generic)+ "'"
    ...
    return dict(pr_doctor_type=pr_doctor_type,recordList=recordList,med_division=med_division,date_from=date_from,date_to=date_to,pr_region=pr_region,reg_name=reg_name,pr_zone=pr_zone,pr_area=pr_area,pr_territory=pr_territory,pr_doctor=pr_doctor,pr_ff=pr_ff,pr_brand=pr_brand)
...
def sin_zm_ranking():
    ...
    doctor_list = []
    if len(str(pr_doctor_type).split(','))>1:
        for i in range(len(pr_doctor_type)):
            doctor_list.append(' '+pr_doctor_type[i])
    else:
        doctor_list.append(' '+pr_doctor_type)
    ...
    if pr_doctor_type!='':
        qset = qset(db.sm_prescription_seen_head.rx_type.belongs(doctor_list))
    ...
    pr_doctor_type = str(pr_doctor_type).split(',')
    pr_doctor_type=str(pr_doctor_type).replace("[","").replace("]","").replace('"'," ").replace("'","")
    
    return dict (pr_doctor_type=pr_doctor_type,records=records,date_from=date_from,date_to=date_to,zm_id=zm_id,zm_name=zm_name,rsm_id=rsm_id,rsm_name=rsm_name,fm_id=fm_id,fm_name=fm_name,tl_id=tl_id,tl_name=tl_name,doc_id=doc_id,doc_name=doc_name,pr_brand=pr_brand)
...
def dr_sin_zm_ranking():
    ...
    doctor_type_list=[]
    d_list=pr_doctor_type.split(',')
    
    for i in range(len(d_list)):
        doctor_type_list.append(d_list[i])
    ...
    # if (pr_doctor_type!=''):
    #     # qset = qset(db.sm_prescription_seen_head.doctor_category == pr_doctor_type)
    #     qset = qset(db.sm_prescription_seen_head.rx_type.like('%'+pr_doctor_type+'%') )
    ...
    if pr_doctor_type!='':
        qset = qset(db.sm_prescription_seen_head.rx_type.belongs(doctor_type_list))
    ...
    return dict (records=records,date_from=date_from,date_to=date_to,pr_doctor_type=pr_doctor_type,zm_id=zm_id,zm_name=zm_name,rsm_id=rsm_id,rsm_name=rsm_name,fm_id=fm_id,fm_name=fm_name,tl_id=tl_id,tl_name=tl_name,doc_id=doc_id,doc_name=doc_name,pr_brand=pr_brand)
...
def dr_sin_mpo_ranking():
    ...
    # if (pr_doctor_type!=''):
    #     # qset = qset(db.sm_prescription_seen_head.rx_type  == pr_doctor_type)
    #     qset =qset(db.sm_prescription_seen_head.rx_type.like('%'+pr_doctor_type+'%') )
