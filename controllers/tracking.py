...
def download_tracking():
    ...
    for rec in records:
        ...
        visited_latlong = 'https://maps.google.com/?q=' + str(rec.visited_latlong).replace(',','+')

        myString+=str(visit_date)+','+str(visit_time)+','+str(rep_id)+','+str(rep_name)+','+str(call_type)+','+str(visited_id)+','+str(visited_name)+','+str(visited_latlong)+'\n'
