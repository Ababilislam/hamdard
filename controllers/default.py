...
#                        menuDivStr="""<div id="accordion" style="width:180px;"> """
                        ...
                        if session.setting_item == 1:
                            if check_role('rm_item_manage') == True or check_role('rm_item_view') == True or check_role('rm_item_batch_manage') == True or check_role('rm_item_batch_view') == True or check_role('rm_item_cat_unit_manage') == True  or check_role('rm_item_cat_unit_view') == True or check_role('rm_depot_belt_manage') == True or check_role('rm_depot_belt_view') == True or check_role('rm_depot_market_manage') == True or check_role('rm_depot_market_view') == True:
                                ...
                                if check_role('rm_depot_market_manage') == True or check_role('rm_depot_market_view') == True:
                                    menuDivStr += """<li ><a href="/""" + appName + """/depot_distributor/index"><div>Branch-Distributor</div></a></li>"""    
                                ...
                                if check_role('rm_item_manage') == True or check_role('rm_item_view') == True:
                                    ...
                                    menuDivStr += """ <li ><a href="/""" + appName + """/seen_rx_brand/seen_rx_brand"><div>RX Brand</div></a></li>"""
                        ...
                        if session.field_force == 1 or session.setting_working_area == 1 or session.utility_settings == 1:
                            if check_role('rm_workingarea_manage') == True or check_role('rm_workingarea_view') == True  or check_role('rm_rep_manage') == True  or check_role('rm_rep_view') == True  or check_role('rm_reparea_manage') == True  or check_role('rm_reparea_view') == True  or check_role('rm_sup_manage') == True  or check_role('rm_sup_view') == True   or check_role('rm_delivery_man_manage') == True or check_role('rm_delivery_man_view') == True or check_role('rm_utility_manage') == True or check_role('rm_ff_target_manage') == True or check_role('rm_ff_target_view') == True:
                                ...
                                menuDivStr += """<li ><a href="/""" + appName + """/doctor/microunion"><div>Pocket Market</div></a></li>"""
                                menuDivStr += """<li ><a href="/""" + appName + """/leave_application_web/leaveList"><div>Leave List</div></a></li>"""
                                menuDivStr += """<li ><a href="/""" + appName + """/active_market_list/active_market_list"><div>Active Market</div></a></li>"""
                                menuDivStr += """</ul>"""
                                menuDivStr += """</div>"""
                        ...
                        if session.user_type == 'Depot' or session.user_type=='Admin':
 #                            if session.user_type=='Admin':
 #                                menuDivStr += """<li ><a href="/""" + appName + """/counter_market_transaction/counter_market_transaction"><div>Stock Transaction
 # </div></a></li>"""
                        # if session.user_id == 'DEMO' :
                            menuDivStr += """<div style=" background-color:#F2F2F2; border-radius:0px; padding:0px 0px 0px 0px; margin:0px; font-size:16px; height:25px; vertical-align:middle; background-image: linear-gradient( #F5F5F5 , #CACACA 50px);"><div id="primarysale">&nbsp;Counter </div></div>"""
                            menuDivStr += """<div style="margin:0px; padding:0px; border:0px;">"""
...
#                                  menuDivStr += """<li ><a href="/""" + appName + """/counter_market_transaction/counter_market_transaction"><div>Stock Transaction
# </div></a></li>"""
                                menuDivStr += """<li ><a href="/""" + appName + """/counter/counter_add"><div>Counter Memo
</div></a></li>"""
                                

                            if session.user_type == 'Depot' or session.user_type=='Admin':
                                
                                menuDivStr += """<li ><a href="/""" + appName + """/counter_invoice/counter_invoice_show"><div>Counter Invoice List
</div></a></li>"""
                                menuDivStr += """<li ><a href="/""" + appName + """/counter_report/counter_report_home"><div>Counter Report</div></a></li>"""
                                menuDivStr += """<li ><a href="/""" + appName + """/counter_memo_return/counter_memo_return_list"><div>Memo Return</div></a></li>"""
                                
                                # menuDivStr += """<li ><a href="/""" + appName + """/counter_market_transaction_show/counter_market_transaction_show"><div>Transaction List</div></a></li>"""
                                menuDivStr += """<li ><a href="/""" + appName + """/counter_item_stock/counter_item_stock"><div>Stock Inventory</div></a></li>"""
                                
                                menuDivStr += """<li ><a href="/""" + appName + """/product_wise_stock/product_stock"><div>Product Wise Inventory</div></a></li>"""
                                
                                menuDivStr += """<li ><a href="/""" + appName + """/counter_customer/counter_customer_list"><div>Counter Customer</div></a></li>"""
                            if session.user_type=='Admin':
                                menuDivStr += """<li ><a href="/""" + appName + """/counter_market_transaction_show/counter_market_transaction_show"><div>Transaction List</div></a></li>"""
                        ...
                        if ((session.field_force == 1 or session.setting_working_area == 1 or session.utility_settings == 1) and (session.user_type != 'Depot')) :
                            if check_role('rm_client_manage') == True or check_role('rm_client_view') == True or check_role('rm_client_cat_manage') == True or check_role('rm_client_cat_view') == True or check_role('rm_client_payment_manage')==True or check_role('rm_client_payment_view')==True or check_role('rm_analysis_view') == True:                                   
                                menuDivStr += """<div style=" background-color:#F2F2F2; border-radius:0px; padding:0px 0px 0px 0px; margin:0px; font-size:16px; height:25px; vertical-align:middle; background-image: linear-gradient( #F5F5F5 , #CACACA 50px);"><div id="primarysale">&nbsp;Counter Settings</div></div>"""
                                menuDivStr += """<div style="margin:0px; padding:0px; border:0px;">"""
                             
                                menuDivStr += """ <li ><a href="/""" + appName + """/physician/physician_add"><div>Physician</div></a></li>"""
                                menuDivStr += """ <li ><a href="/""" + appName + """/physician_depot/physician_depot_add"><div>Physician_Depot</div></a></li>"""
                                
                                menuDivStr += """ <li ><a href="/""" + appName + """/discount_type/discount_type"><div>Discount Type</div></a></li>"""
                                menuDivStr += """ <li ><a href="/""" + appName + """/counter_item_discount/counter_item_discount_add"><div>Counter Item Discount</div></a></li>"""
                        menuDivStr += """</ul>"""
                        menuDivStr += """</div>"""   

                        if session.setting_client == 1 or session.setting_report == 1:
                            if check_role('rm_client_manage') == True or check_role('rm_client_view') == True or check_role('rm_client_cat_manage') == True or check_role('rm_client_cat_view') == True or check_role('rm_client_payment_manage')==True or check_role('rm_client_payment_view')==True or check_role('rm_analysis_view') == True:                                   
                                menuDivStr += """<div style=" background-color:#F2F2F2; border-radius:0px; padding:0px 0px 0px 0px; margin:0px; font-size:16px; height:25px; vertical-align:middle; background-image: linear-gradient( #F5F5F5 , #CACACA 50px);"><div id="primarysale">&nbsp;Party</div></div>"""
                                menuDivStr += """<div style="margin:0px; padding:0px; border:0px;">"""
                                ...
                                if check_role('rm_client_manage') == True or check_role('rm_client_view') == True:
                                    menuDivStr += """<li ><a href="/""" + appName + """/client/client"><div>Party List</div></a></li>"""
...
#                                     menuDivStr += """<li ><a href="/""" + appName + """/depot/depot_payment"><div>Payment</div></a></li>"""
                        ...
                        if (session.user_type == 'Depot' and session.depot_id=='DEMOBR') or session.user_type == 'Admin':
                            menuDivStr += """<div style=" background-color:#F2F2F2; border-radius:0px; padding:0px 0px 0px 0px; margin:0px; font-size:16px; height:25px; vertical-align:middle; background-image: linear-gradient( #F5F5F5 , #CACACA 50px);"><div id="primarysale">&nbsp;Branch Costing</div></div>"""
                            menuDivStr += """<div style="margin:0px; padding:0px; border:0px;">"""
                            menuDivStr += """<li ><a href="/""" + appName + """/branch_costing/branch_costing"><div>Branch Cost</div></a></li>"""
...
#                                        menuDivStr += """<ul>"""
        ...
        #                                
                        ...
                        if session.setting_doctor==1:
                            if check_role('rm_doctor_visit_rx_view') == True or check_role('rm_doctor_visit_seen_view') == True or check_role('rm_doctor_manage') == True or check_role('rm_doctor_view') == True or check_role('rm_doctor_visit_manage') == True or check_role('rm_doctor_visit_view') == True or check_role('rm_doctor_visit_plan_manage') == True or check_role('rm_doctor_visit_plan_view') == True or check_role('rm_doctor_inbox_manage') == True:
...
#                                if check_role('rm_doctor_visit_manage') == True or check_role('rm_doctor_visit_view') == True:
                                ...
                                if check_role('rm_doctor_visit_rx_view') == True:
                                ...
                                if check_role('rm_doctor_visit_seen_view') == True:
...
#                                        menuDivStr += """<li ><a href="/""" + appName + """/showMap_doctor/index"><div>Map</div></a></li>"""
                                    ...
                                    if session.user_type=='Admin':
                                        menuDivStr+="""<li ><a href="/"""+appName+"""/doctor_speciality/speciality_add"><div>Speciality</div></a></li>"""
                                        menuDivStr+="""<li ><a href="/"""+appName+"""/doctor_degree/degree_add"><div>Degree</div></a></li>"""
                                        ...
                                        if session.ppm == 1:
                                            ...
                                            menuDivStr+="""<li ><a href="/"""+appName+"""/doctor_sample/sample_add"><div>Sample</div></a></li>"""                                
...
#                                         menuDivStr += """<li ><a href="/""" + appName + """/doctor_visit/prescription_list"><div>Prescription</div></a></li>"""
                        ...
                        if session.setting_report == 1:# if open set 1
                            if check_role('rm_tour_view') == True or check_role('rm_tracking_view') == True or check_role('rm_rpt_sales2') == True or check_role('rm_rpt_sales') == True or check_role('rm_rpt_stock_and_coll') == True or check_role('rm_rpt_analysis') == True or check_role('rm_rpt_sales_dist') == True:  #Reports
...
#                                     menuDivStr += """<li ><a href="/""" + appName + """/dashboard/dashboard"><div>Dashboard</div></a></li>"""
                                ...
                                #if session.user_type == 'Admin':
                                if check_role('rm_tracking_view') == True:
                                    menuDivStr += """<li ><a href="/""" + appName + """/tracking/tracking"><div>Tracking</div></a></li>"""

                                if check_role('rm_tour_view') == True:
                                    menuDivStr += """<li ><a href="/""" + appName + """/report_tour/home"><div>Tour</div></a></li>"""
                                
                                if session.user_type=='Admin':
                                    menuDivStr += """<li ><a  href="/""" + appName + """/client_coverage_report/client_coverage_url?cid=Hamdard&rep_id=3605&rep_pass=7777" target="_blank"><div>Client Coverage</div></a></li>"""
...
#                                 menuDivStr += """</div>"""
                        ...
                        if session.utility_settings == 1:
                            if check_role('rm_campaign_manage') == True or check_role('rm_campaign_view') == True:
                                menuDivStr += """<div style=" background-color:#F2F2F2; border-radius:0px; padding:0px 0px 0px 0px; margin:0px; font-size:16px; height:25px; vertical-align:middle; background-image: linear-gradient( #F5F5F5 , #CACACA 50px);"><div id="tour">&nbsp;Tour</div></div>"""
                                menuDivStr += """<div style="margin:0px; padding:0px; border:0px;">"""
                                menuDivStr += """<ul>"""
                                
                                if check_role('rm_campaign_manage') == True or check_role('rm_campaign_view') == True:
                                    menuDivStr += """<li ><a href="/""" + appName + """/tour/home"><div>Tour Plan</div></a></li>"""                                    
...
#                                     menuDivStr+="""<li ><a href="/"""+appName+"""/utility/depot_opening_balance"><div>Depot Opening</div></a></li>"""
                                ...
                                if check_role('rm_utility_manage') == True:
                                    ...
                                    menuDivStr += """<li ><a href="/""" + appName + """/settings/base_mobile2"><div>Base Mobile</div></a></li>"""
                                    

                                    if session.user_type == 'Admin':
                                        menuDivStr += """<li ><a href="/""" + appName + """/settings/order_process"><div>Order Process</div></a></li>"""
...
#                         
                        ...
                        if session.user_type!='Supervisor':
                            ...
                            if session.user_type=='Depot':
                                menuDivStr += """<li ><a href="/""" + appName + """/batch_id_update/batch_update" target="_blank"><div>Batch ID Update</div></a></li>"""     
...
#         url = 'http://e.businesssolutionapps.com/cpanel/get_depot/get_depot?depot_data=' + request_text
        url = 'http://ww11.yeapps.com/cpanelmrep/get_depot/get_depot?depot_data=' + request_text
        
        result = fetch(url)
#        result= urllib.parse.urlopen(url)
#        result= result.read()
...
def get_sample_list():
    ...
    rows = db((db.sm_doctor_sample.cid == cid) & (db.sm_doctor_sample.status == 'ACTIVE')).select(db.sm_doctor_sample.item_id, db.sm_doctor_sample.name, orderby=db.sm_doctor_sample.name)
    ...
    return retStr
                 ...
                 ######### TOUR PLAN ID|NAME AUTO COMPLETE USING AJAX ###########

def get_id_list():
    ret_id_Str = ''

    id_list_sql = "select rep_id,name from sm_rep group by rep_id order by rep_id;"
    # return poiRows_sql
    id_list = db.executesql(id_list_sql, as_dict=True)
    for a in range(len(id_list)):
        records_dict=id_list[a]   
        rep_id=str(records_dict["rep_id"])      
        name=str(records_dict["name"])      
        if ret_id_Str == '':
            ret_id_Str = rep_id+'|'+name
        else:
            ret_id_Str += ',' +rep_id+'|'+name
    ...
    return ret_id_Str
                 ...
                 ######### TOUR PLAN MONTH AUTO COMPLETE USING AJAX ###########
...
def get_month_list():
    ...
    for i in months_list:
        records_ov_dict = i   
        if ret_month_Str == '':
            ret_month_Str = records_ov_dict
        else:
            ret_month_Str += ',' + records_ov_dict
    
    return ret_month_Str





                 ######### TOUR PLAN LEVEL NAME AUTO COMPLETE USING AJAX ###########

def get_level_list():
    ret_level_Str = ''
    level_list = ['FF', 'AREA', 'ZONE', 'DIVISION']
    for i in level_list:
        records_ov = i   
        if ret_level_Str == '':
            ret_level_Str = records_ov
        else:
            ret_level_Str += ',' + records_ov
    
    return ret_level_Str
                 ...
                 ######### TOUR PLAN STATUS AUTO COMPLETE USING AJAX ###########

def get_status_list():
    ret_status_Str = ''
    get_status_sql = "select status FROM `sm_doctor_visit_plan` GROUP by status;"
    status_list = db.executesql(get_status_sql, as_dict=True)
    for i in range(len(status_list)):
        records_ov_dict=status_list[i]   
        status=str(records_ov_dict["status"])      
        if ret_status_Str == '':
            ret_status_Str = status
        else:
            ret_status_Str += ',' +status
    
    return ret_status_Str

def get_item_data_list_invoice():
    retStr = ''
    cid = session.cid
    rows = db((db.sm_item.cid == cid) & (db.sm_item.status == 'ACTIVE')).select(db.sm_item.item_id, db.sm_item.name, db.sm_item.category_id, db.sm_item.dist_price, db.sm_item.price, orderby=db.sm_item.name)
    for row in rows:
        item_id = str(row.item_id)
        name = str(row.name).replace('|', ' ').replace(',', ' ')
        category_id = str(row.category_id).replace('|', ' ').replace(',', ' ')
