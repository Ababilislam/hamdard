...
def sales_report_zm_0():
    ...
    if (user_type=='SUP'):
        ...
        qstInvcCount = qstInvcCount(db.sm_invoice_head.return_count == 0)
...
def sales_report_zm():
    ...
    if (session.from_dt==None or session.from_dt=='None' or session.to_date==None or session.to_date=='None'):
        date_from=current_date
