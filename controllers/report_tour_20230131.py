...
def tour_plan():
    ...
    records=qset.select(db.sm_doctor_visit_plan.rep_id,db.sm_doctor_visit_plan.rep_name,db.sm_doctor_visit_plan.route_name,db.sm_doctor_visit_plan.schedule_date,db.sm_doctor_visit_plan.note, orderby=db.sm_doctor_visit_plan.schedule_date|db.sm_doctor_visit_plan.rep_id, groupby=db.sm_doctor_visit_plan.schedule_date|db.sm_doctor_visit_plan.rep_id)
    # return pr_ff
#    ================================
