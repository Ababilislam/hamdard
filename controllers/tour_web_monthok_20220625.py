...
def tourPending():
    ...
    pendinginfo = db((db.sm_doctor_visit_plan.cid==session.cid)   & (db.sm_doctor_visit_plan.status=='CReq') & (db.sm_doctor_visit_plan.schedule_date== s_date)).select(db.sm_doctor_visit_plan.route_id,db.sm_doctor_visit_plan.route_name,db.sm_doctor_visit_plan.note,db.sm_doctor_visit_plan.status, orderby=~db.sm_doctor_visit_plan.note)    
    # return pendinginfo
