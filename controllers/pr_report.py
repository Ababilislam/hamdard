...
def get_pocket_market():
    ...
    records=db((db.sm_microunion.cid == c_id)&(db.sm_microunion.level0 == region)&(db.sm_microunion.level1 == zone)&(db.sm_microunion.level2 == area)&(db.sm_microunion.level3 == territory)).select(db.sm_microunion.microunion_id, db.sm_microunion.microunion_name, orderby=db.sm_microunion.microunion_name)
    # return db._lastsql
    for row in records:
