...
def home():
    ...
    return dict(rec_item=rec_item,search_item_id_name=search_item_id_name,user_type=user_type,records=records,recordsH=recordsH,level_list=level_list,level_area_list=level_area_list,seen_rx_type_list=seen_rx_type_list)
