...
def return_note_preview():
    ...
    return dict(data_List=data_List,fromDate=fromDate,toDate=toDate,depotID=depot_id,depotName=depot_name,storeID=store_id,storeName=store_name)    
