...
def index():
    ...
    btn_dcrSummary_detail=request.vars.btn_dcrSummary_detail
    btn_dcrSummary_detailD=request.vars.btn_dcrSummary_detailD
...
#     return btn_dcrMsoD
    if (btn_dcrRegion or btn_dcrRegionD or btn_dcrFm or btn_dcrFmD or btn_dcrTeritory or btn_dcrMso or btn_dcrMsoD or btn_dcrVisit or btn_dcrTeritoryD or btn_dcrDoc or btn_dcrDocD or btn_dcrSummary or btn_dcrSummaryD or btn_dcrSummary_detail or btn_dcrSummary_detailD or btn_dcrVSummary or btn_dcrVSummaryD or btn_dcrVSummarProduct or btn_dcrVSummarProductD or btn_prSummary or btn_prSummaryD or btn_tourSummary or btn_tourSummaryD or btn_tourVSummary or btn_tourVSummaryD or btn_tourDateVSummary or btn_tourDateVSummaryD or dcr_day_count):
...
#         return    dateFlag  
        if dateFlag!=False:
            ...
            if btn_dcrSummary_detail:
                redirect (URL('dcrSummary_detail',vars=dict(date_from=date_from,date_to=date_to,depot_id=depot_id,depot_name=depot_name,rsm_id=rsm_id,rsm_name=rsm_name,fm_id=fm_id,fm_name=fm_name,tr_id=tr_id,tr_name=tr_name,product_id=product_id,product_name=product_name,brand=brand,category=category,mso_id=mso_id,mso_name=mso_name,doc=doc,doc_name=doc_name)))
            if btn_dcrSummary_detailD:
                redirect (URL('dcrSummary_detailD',vars=dict(date_from=date_from,date_to=date_to,depot_id=depot_id,depot_name=depot_name,rsm_id=rsm_id,rsm_name=rsm_name,fm_id=fm_id,fm_name=fm_name,tr_id=tr_id,tr_name=tr_name,product_id=product_id,product_name=product_name,brand=brand,category=category,mso_id=mso_id,mso_name=mso_name,doc=doc,doc_name=doc_name)))
...
#     return date_from
    ...
    records = qset.select(db.sm_doctor_visit.level1_id,db.sm_doctor_visit.level2_id,db.sm_doctor_visit.route_id,db.sm_level.territory_des,db.sm_doctor_visit.rep_id,db.sm_doctor_visit.rep_name,db.sm_doctor_visit.doc_id,db.sm_doctor_visit.doc_name,db.sm_doctor_visit.id.count(), orderby= db.sm_doctor_visit.level1_id|db.sm_doctor_visit.level2_id|db.sm_doctor_visit.route_id|db.sm_doctor_visit.rep_id|db.sm_doctor_visit.rep_name ,groupby= db.sm_doctor_visit.level1_id|db.sm_doctor_visit.level2_id|db.sm_doctor_visit.route_id|db.sm_doctor_visit.rep_id|db.sm_doctor_visit.rep_name|db.sm_doctor_visit.doc_id|db.sm_doctor_visit.doc_name)
#     return db._lastsql
#     return records
    return dict(records=records,date_from=date_from,date_to=date_to,depot_id=depot_id,depot_name=depot_name,rsm_id=rsm_id,rsm_name=rsm_name,fm_id=fm_id,fm_name=fm_name,tr_id=tr_id,tr_name=tr_name,brand=brand,category=category,product_id=product_id,product_name=product_name,mso_id=mso_id,mso_name=mso_name,doc=doc,doc_name=doc_name)

def dcrSummary_detailD():
...
#     return date_from
    ...
    records = qset.select(db.sm_doctor_visit.visit_date,db.sm_doctor_visit.level1_id,db.sm_doctor_visit.level2_id,db.sm_doctor_visit.route_id,db.sm_level.territory_des,db.sm_doctor_visit.rep_id,db.sm_doctor_visit.rep_name,db.sm_doctor_visit.doc_id,db.sm_doctor_visit.doc_name,db.sm_doctor_visit.id.count(), orderby= db.sm_doctor_visit.level1_id|db.sm_doctor_visit.level2_id|db.sm_doctor_visit.route_id|db.sm_doctor_visit.rep_id|db.sm_doctor_visit.rep_name ,groupby= db.sm_doctor_visit.level1_id|db.sm_doctor_visit.level2_id|db.sm_doctor_visit.route_id|db.sm_doctor_visit.rep_id|db.sm_doctor_visit.rep_name|db.sm_doctor_visit.doc_id|db.sm_doctor_visit.doc_name|db.sm_doctor_visit.visit_date)
    # return records
...
#     myString+='Category,'+category+'\n'
    myString+='Doctor,'+doc+'|'+doc_name+'\n\n'
    myString+=' Date, RSM  ,  FM  ,  TR   , TR Desc ,   MSO,MSOName , DCR Count, DoctorID, DoctorName\n'
        
    
    for record in records:
        myString+=str(record[db.sm_doctor_visit.visit_date])+','+str(record[db.sm_doctor_visit.level1_id])+','+str(record[db.sm_doctor_visit.level2_id])+','+str(record[db.sm_doctor_visit.route_id])+','+str(record[db.sm_level.territory_des])+','+str(record[db.sm_doctor_visit.rep_id])+','+str(record[db.sm_doctor_visit.rep_name])+','+str(record[db.sm_doctor_visit.id.count()])+','+str(record[db.sm_doctor_visit.doc_id])+','+str(record[db.sm_doctor_visit.doc_name])+'\n'
             
        #Save as csv
    # return myString
    import gluon.contenttype
    response.headers['Content-Type'] = gluon.contenttype.contenttype('.csv')
    response.headers['Content-disposition'] = 'attachment; filename=DCR_Detail.csv'   
    return str(myString)
