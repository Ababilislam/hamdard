...
def salesDcr_report_detail():
    ...
    if (user_type=='REP'):
        ...
        records = qset.select(db.sm_doctor_visit.doc_id.count(),db.sm_doctor_visit.doc_id,db.sm_doctor_visit.rep_id,db.sm_doctor_visit.route_id,db.sm_doctor_visit.route_name,db.sm_doctor_visit.visit_date,db.sm_doctor_visit.level2_id,db.sm_doctor_visit.level2_name, orderby=db.sm_doctor_visit.visit_date, groupby=db.sm_doctor_visit.route_id)
        doc_id_list=[]
        visit_date_list=[]
        if records:
            for i in range(len(records)):
    ...
    if (user_type=='SUP'):
        ...
        records = qset.select(db.sm_doctor_visit.doc_id.count(),db.sm_doctor_visit.rep_id,db.sm_doctor_visit.doc_id,db.sm_doctor_visit.route_id,db.sm_doctor_visit.route_name,db.sm_doctor_visit.visit_date,db.sm_doctor_visit.level2_id,db.sm_doctor_visit.level2_name, orderby=~db.sm_doctor_visit.visit_date, groupby=db.sm_doctor_visit.route_id)
        # return db._lastsql
        doc_id_list=[]
        visit_date_list=[]
        if records:
