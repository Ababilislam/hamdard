...
def inv_preview_dist():
    ...
    # return db._lastsql
        # -------------------------
    return dict(dist_discount=dist_discount,data_List=data_List, dist_id=dist_id, dist_name=dist_name,fromDate=fromDate,toDate=toDate, fmcg_item = fmcg_item)
